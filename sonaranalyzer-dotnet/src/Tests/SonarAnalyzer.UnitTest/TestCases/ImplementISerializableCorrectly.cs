...
//         ^^^^^ Secondary@-1 {{Add 'System.SerializableAttribute' attribute on 'Serializable_NoAttribute' because it implements 'ISerializable'.}}
    {
        ...
        { /*do something*/ }
        public void GetObjectData(SerializationInfo info, StreamingContext context)
//                  ^^^^^^^^^^^^^ Secondary {{Make this method 'public' and 'virtual', or seal 'Serializable_NoAttribute'.}}
        { /*do something*/ }
    }
...
//                         ^^^^^^^^^^^^^ Secondary {{Make this method 'public' and 'virtual', or seal 'Serializable_ExplicitImplementation'.}}
        { /*do something*/ }
    }
